...
Chaos engine (on sega genesis, this game is called
--------------------------------------------------
...
Stage select:
    at main menu pres: ``L``, ``up``, ``X``, ``up``, ``R``, ``Y``, ``start``.
...
::
    ...
    7e150000    # always level zero in gameplay.
(code must be turned on before gameplay.)
...
::
    ...
    7e041401    # invincible
    7e1a9d08    # lives
    7e1a9807    # level 4 (7e1a9803, 7e1a9806)
